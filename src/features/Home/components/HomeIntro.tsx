...
const HomeIntro = () => {
  ...
  return (
    <Container className={"grid grid-cols-3 gap-3 py-24"}>
      <div className="col-span-2">
        <p className="text-4xl tracking-wider font-medium font-poppins">
          Japan, A Land of Timeless Beauty
        </p>
        <p className="text-xl mt-4">( 永遠の美を誇る国、日本 )</p>
        <p className="mt-9 pe-12 text-lg">
      ...
      <div
        ...
        className="p-3 group overflow-hidden"
      >
...
const IntroCard = ({ content }) => {
  return (
    <div className="p-6 bg-neutral-100">
      ...
      <p className="text-justify mt-6 text-gray-800">
        {content.content}.
      </p>
    </div>
  );
